...
if (items.length > 0) {
  ...
  pOne.style.width = "90%";
  pOne.style.background =
    "linear-gradient(145deg, var(--btn-primary), var(--btn-secondary))";
  pOne.style.color = "white";
  pOne.innerText = `${person} has no items in their wishlist`;
